package com.mh.notification.mock.config;
...
public class MockProperties {
    ...
    public static class Log {
        ...
        public boolean isIncludeMaskedMessagePreview() {
            return includeMaskedMessagePreview;
        }

        public void setIncludeMaskedMessagePreview(boolean includeMaskedMessagePreview) {
            this.includeMaskedMessagePreview = includeMaskedMessagePreview;
        }

        public int getMessagePreviewLength() {
            return messagePreviewLength;
        }

        public void setMessagePreviewLength(int messagePreviewLength) {
            this.messagePreviewLength = messagePreviewLength;
        }
    }
}